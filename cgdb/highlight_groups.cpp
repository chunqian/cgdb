...
static const struct default_hl_group_info default_groups_for_background_dark[]
        = {
    {HLG_KEYWORD, SWIN_A_BOLD, SWIN_A_BOLD, COLOR_MAGENTA, -1},
    {HLG_TYPE, SWIN_A_BOLD, SWIN_A_BOLD, COLOR_BLUE, -1},
    {HLG_LITERAL, SWIN_A_BOLD, SWIN_A_BOLD, COLOR_YELLOW, -1},
    {HLG_COMMENT, SWIN_A_NORMAL, SWIN_A_NORMAL, -1, -1},
    ...
    {HLG_SELECTED_LINE_ARROW, SWIN_A_BOLD, SWIN_A_BOLD, COLOR_YELLOW, -1},
